    ...
    <div className='hero'>
      <div className="wrapper">
        <motion.div className="textcontainer" variants={textVariants} initial="initial" animate="animate">
          <motion.h2 variants={textVariants}>ADARSH KP</motion.h2>
          <motion.h1 variants={textVariants}>Web Developer</motion.h1>
          <motion.div variants={textVariants} className="buttons">
            <motion.button variants={textVariants}>Veiw The Resume </motion.button>
      ...
      <motion.div  className="slidetextcontainer" variants={sliderVariants}  initial="initial" animate="animate">
        Web-Developer Photographer Technicus
      </motion.div>
